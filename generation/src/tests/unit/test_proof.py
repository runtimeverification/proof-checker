...
def test_prove_imp_reflexivity() -> None:
    ...
    assert bytes(out.getbuffer()) == bytes([
        ...
        Instruction.Save,               # @1
        Instruction.Instantiate, 1,     # Stack: prop2[ph0 -> ph0/0]

        Instruction.Load, 0,            # Stack: prop2[ph0 -> ph0/0] ; ph0
        Instruction.Instantiate, 2,     # Stack: [p1: (ph0 -> (ph0 -> ph0) -> ph0) -> (ph0 -> (ph0 -> ph0)) -> (ph0 -> ph0)]

        Instruction.Prop1,              # Stack: p1 ; prop1
        Instruction.Load, 1,            # Stack: p1 ; prop1 ; $ph0 -> ph0
        Instruction.Instantiate, 1,     # Stack: p1 ; [p2: (ph0 -> (ph0 -> ph0) -> ph0) ]
        ...
        Instruction.Instantiate, 1,     # Stack: p3 ; ph0 -> ph0 -> ph0
