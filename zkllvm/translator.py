...
def generate_zkllvm_input_from_file(file_path: str) -> str:
    int_list = []
...
def main() -> None:
    ...
    parser.add_argument('assumption', type=str, help='The path to the assumption file.')

    parser.add_argument('claim', type=str, help='The path to the claim file.')

    parser.add_argument('proof', type=str, help='The path to the proof file.')
