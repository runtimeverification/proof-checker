...
proofs/generated-from-k/%.ml-proof.kgenerate: proofs/generated-from-k/%.ml-proof
	poetry -C generation run python -m "kore_transfer.proof_gen" generation/k-benchmarks/single-rewrite/$*.k generation/k-benchmarks/single-rewrite/foo-a.$* .build/kompiled-definitions  --depth 0 --proof-dir proofs/generated-from-k/
...
.build/proofs/generated-from-k/%.ml-proof: FORCE
	poetry -C generation run python -m "kore_transfer.proof_gen" generation/k-benchmarks/single-rewrite/$*.k generation/k-benchmarks/single-rewrite/foo-a.$* .build/kompiled-definitions  --depth 0 --proof-dir .build/proofs/generated-from-k/
